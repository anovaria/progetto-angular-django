@echo off
REM ============================================================================
REM  Riordino Fornitori AUTOMATICO - PILOTA Drogheria Alimenti (DRY-RUN)
REM ----------------------------------------------------------------------------
...
REM  Drogheria Alimenti (CCOM 804804).
REM
REM  NB CADENZA: il task legacy gira OGNI 2 SETTIMANE il mercoledi' (biweekly),
REM  non settimanale -> schedularlo /SC WEEKLY /MO 2 /D WED allineando la fase.
REM  NB ATTENZIONE: il task legacy di srviis FALLISCE 0x1 -> potrebbe non produrre
REM  un CSV reale da confrontare (e Drogheria potrebbe non riordinare da tempo).
REM
...
REM Parametri allineati allo script legacy del task srviis per Drogheria Alimenti:
REM   OrdineFornitore_04_dash @contrcomme=804804 @ggcons=7 @ggcop=7 @tipOrd=0 @perc=50
...
venv\Scripts\python.exe manage.py rio_auto --ccom 804804 --gg-cons 7 --gg-cop 7 --canale central --no-dry-run
