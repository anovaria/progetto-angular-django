@echo off
REM ============================================================================
REM  Riordino Fornitori AUTOMATICO - PILOTA Valpi Alimentare "1" (DRY-RUN)
REM ----------------------------------------------------------------------------
...
REM  Valpi Alimentare CCOM 806984 (secondo contratto/canale, distinto da 805387).
REM
REM  NB CADENZA: il task legacy gira il LUNEDI' (confermare l'orario dal task
REM  legacy) -> schedularlo /SC WEEKLY /D MON /ST <hh:mm> allineando la fase.
REM
...
REM Parametri allineati allo script legacy del task srviis per Valpi (806984):
REM   OrdineFornitore_04_dash @contrcomme=806984 @ggcons=3 @ggcop=7 @tipOrd=0 @perc=50
...
venv\Scripts\python.exe manage.py rio_auto --ccom 806984 --gg-cons 3 --gg-cop 7 --canale central --dry-run
