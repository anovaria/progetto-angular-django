...
# t_ArtPromoStessoPrezzo: articoli in promo con prezzo offerta = prezzo di vendita
COLONNE = [
    ('DTAAGGIO',  'Data Agg.'),
    ('OPLCEXOPR', 'Cod. Promo'),
    ('DTAINI',    'Data Inizio'),
...
def main(request):
    ...
    return render(request, 'stesso_prezzo/main.html', ctx)
...
def export_excel(request):
    ...
    response['Content-Disposition'] = 'attachment; filename="stesso_prezzo.xlsx"'
    wb.save(response)
    return response
