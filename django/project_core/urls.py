...
urlpatterns = [
    ...
    path('app/asso-articoli/', include('modules.asso_articoli.urls')),
    ...
    path('app/rio-fornitori/', include('modules.rio_fornitori.urls', namespace='rio-fornitori')),
    path('app/rio-fornitori-new/', include('modules.rio_fornitori_new.urls', namespace='rio-fornitori-new')),
